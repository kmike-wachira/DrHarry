    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li>
            <a href="login.php"><span class="glyphicon  glyphicon-log-in"></span>Login<i class="fa fa-caret-down"></i></a>
          </li>
          <li> <a href="reg.php"><span class="glyphicon glyphicon-user"></span> Sign up<i class="fa fa-caret-down"></i></a></li>
        </ul>
      </div>
    </div>
  </nav> <br><br> <br><br>
